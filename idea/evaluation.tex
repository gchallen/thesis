...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./idea/figs/lpltune_topology.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./idea/figs/graph_lpl_interval_comparison.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./idea/figs/graph_update_rate_overhead.pdf}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./idea/figs/Placeholder.pdf}
%\end{center}
...
%\XXXnote{GWA: A lot of this text should be moved to the discussion and out of
%the caption.}
%Similar to Figure~\ref{fig-lplvoptimalmotelab}, this figure shows results for
...
\begin{center}
\textbf{(a)}\\
\includegraphics[width=\hsize]{./idea/figs/STOCK.pdf}\\
\textbf{(b)}\\
\includegraphics[width=\hsize]{./idea/figs/ICTP.pdf}\\
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=\hsize]{./idea/figs/graph_density_vs_time0406_2151.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./idea/figs/graph_capability_vs_time1210_2100.pdf}
\end{center}
