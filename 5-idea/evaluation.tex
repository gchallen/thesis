...
To evaluate IDEA, we build and test the energy-aware component and
...
approaches that is not energy-aware. For the application, we use IDEA to
...
(LPL)~\cite{tinyos-lpl}, which is important to properly model the power
