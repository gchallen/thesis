...
Section~\ref{idea-sec-casestudies}, including a component that tunes MAC
parameters, an existing routing protocol modified to choose energy-aware
routes, and a application using IDEA to determine how
to localize acoustic events.
...
enables improvements in lifetime of up to 35\%.
