...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.7\hsize]{./casestudy/figs/schematic}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=0.7\hsize]{./casestudy/figs/Station}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.7\hsize]{./casestudy/figs/TEST}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.7\hsize]{./casestudy/figs/Node-212-5}
\end{center}
\caption{\small {\bf {One of our two-component stations.  The blue Pelican
Case contains the wireless sensor network node and hardware interface board.
The external antenna is mounted on the PVC pole to reduce ground effects.
