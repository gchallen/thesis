...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./evaluation/figs/robustness/nodesalive/nodesalive.pdf}
\end{center}
...
%% \XXXnote{MDW: Earlier we say that we returned to the deployment site
%% ``three times'' but this is inconsistent with the above mention of a
%% ''third visit'' to the site (I think we went to the site a total of 6
%% times: two for deployment, three for repair, one for takedown). 
%% I suggest just removing the mention of the three times in design.tex?}
...
% MDW 26-Aug-06: I prefer ``we'' rather than ``a researcher'' here. It is
% more typical of technical writing and is a bit less awkward. 
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./evaluation/figs/robustness/nodesalive/node-uptime2.pdf}
\end{center}
...
Figure~\ref{fig-nodeuptime} shows the uptime for each node during the 19-day
deployment. Each bar consists of three portions. The lowest portion is the
{\em apparent} uptime of each node accounting for both the base station
...
%\begin{figure}[t]
%  \begin{center}
%    \includegraphics[width=\hsize]{./evaluation/figs/robustness/nodeReboots/nodeReboots.pdf}
%  \end{center}
...
%\begin{figure}[t]
%  \begin{center}
%    \includegraphics[width=\hsize]{./evaluation/figs/robustness/nodeReboots/nodeRebootsBinned.pdf}
%  \end{center}
