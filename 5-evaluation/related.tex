...
% 22 Apr 2006 : GWA : General idea is to split up work between scientific
%               (GDI, Macroscope, etc) and other high data rate sensing
%               applications that have been studied (NetSHM, North Sea, etc.)
%               I'm going to try and get the highlights on the first pass and
%               then we can add stuff later.
...
Island~\cite{spm:04habitat,polastre-masters,mainwaring-habitat}, 
Berkeley Redwood Forest~\cite{berkeley-redwoods}, and 
James Reserve~\cite{cerpa-habitat} deployments. These systems are 
...
Redwood Forest deployment~\cite{berkeley-redwoods}, which involved
...
NetSHM~\cite{netshm-ewsnsubmission,netshm-emnets05,wisan} is a 
...
% MDW: We can keep this since there is room
