...
set output '213VREFTEK-POSITIVE48MS-OFFSET.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set ylabel "Ground Displacement, Vertical Axis (Sample Value)" 0.000000,0.000000  font ""
...
plot 'node-213.dat' u (($1 - 1124122014) - 0.048):($2) w l lw 4 lt 1 t "213 shifted 48 ms earlier", 'node-9024.dat' u ($1 - 1124122014):($2) w l lw 4 lt 3 t "RVEN"
#    EOF
