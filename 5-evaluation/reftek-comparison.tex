...
%This demonstrates that the time rectification process was able to recover
%accurate timing for these signals.

%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./5-evaluation/figs/timing/TimingErrors/TIMINGFAILURES.pdf}
%\end{center}
