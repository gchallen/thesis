...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./5-evaluation/figs/timing/}
%\end{center}
...
\end{center} 
\caption{\textbf{Example of FTSP instability observed during field
deployment.}
...
Section~\ref{evaluation-sec-hardware}). Adjusting for this delay resulted in
an indiscernible offset between the sensor node and Reftek signals. While
