...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/linear/BOTH.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/error/ERROR.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/crossover/BANDWIDTHVENERGY.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/zipfian/POLICIES.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/speeds/POLICIES.pdf}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.45\hsize]{./lance/figs/gwa/topologies/25.pdf} &
\includegraphics[width=0.45\hsize]{./lance/figs/gwa/topologies/50.pdf} \\
(a) &
(b)\\
\end{tabular}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/big/FIGURE.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1.0\hsize]{./lance/figs/gwa/policy/FILL.pdf}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=1.0\hsize]{./lance/figs/gwa/marm/CDF.pdf}
%\end{center}
%\caption{\small {\bf Usage of policy modules to affect download
%distribution.} 
%{\em Here we illustrate the use of policy modules in the context of
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=1.0\hsize]{./lance/figs/gwa/motelab/TOPOLOGY.pdf}
%\end{center}
