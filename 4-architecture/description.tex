...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.8\hsize]{./4-architecture/figs/2005-deployment-map.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.8\hsize]{./4-architecture/figs/2007-deployment-map.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\hsize]{./4-architecture/figs/TEST}
\end{center}
...
\begin{center}
\includegraphics[width=1.0\hsize]{./4-architecture/figs/Station2-small.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=1.0\hsize]{./4-architecture/figs/schematic2.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=1.0\hsize]{./4-architecture/figs/reventador-map-crop.pdf}
\end{center}
