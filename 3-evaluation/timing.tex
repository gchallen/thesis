...
The original FTSP work~\cite{ftsp} reports timing errors of less than
67~$\mu$s for an 11-hop network of Mica2 nodes. We verified in our testbed
that FTSP provided a 90th-percentile time error of under 2.1~ms in a 5-hop
linear network of TMote Sky nodes.
