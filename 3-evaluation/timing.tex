...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=\hsize]{./3-evaluation/figs/timing/MDW/instability/FTSPINSTABILITY.pdf}
\end{center} 
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.8\hsize]{./3-evaluation/figs/timing/RectificationCartoon/cartoon.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./3-evaluation/figs/timing/MDW/rectification/rectify.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\hsize]{./3-evaluation/figs/timing/RV213/2005-08-15_09.11.28/213VREFTEK-NEGATIVE29MS-OFFSET.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\hsize]{./3-evaluation/figs/timing/RV213/Table/213-GOODDIFFS2.pdf}
\end{center}
...
Figure~\ref{evaluation-fig-rvenv213} shows an example of this process that
