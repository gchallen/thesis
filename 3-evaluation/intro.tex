...
19~days.  The core contribution of this chapter is an analysis of the
efficacy and accuracy of a volcano-monitoring sensor network as a scientific
instrument.  The rest of the chapter evaluates the data collected during our
field deployment along the following axes:
