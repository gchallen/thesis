...
set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 22
set output 'Comparison-Unshifted.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xrange [ 51.0000 : 53.0000 ] noreverse nowriteback
set x2range [ 50.3849 : 52.0391 ] noreverse nowriteback
set ylabel "Scaled Output" 0.000000,0.000000  font ""
set y2label "" 0.000000,0.000000  font ""
set yrange [ -0.471976 : 0.621100 ] noreverse nowriteback
set y2range [ -0.526876 : 0.478034 ] noreverse nowriteback
...
plot 'node-202.filtered' u ($1 - 1143236096.88):2 w l t 'Node 202 Unshifted', 'node-9024.filtered' u ($1 - 1143236096.88):($5 / 0.0008) w l t 'Reftek Unshifted'
#    EOF
