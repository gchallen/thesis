...
plot 'node-202.filtered' u ($1 - 1143236096.88 - 0.028):2 w l t 'Node 202 shifted 28 ms earlier', 'node-9024.filtered' u ($1 - 1143236096.88):($5 / 0.0008) w l t 'Reftek Unshifted'
#    EOF
