...
set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 18
set output 'FTSPVMAPPEDNODE0.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
plot 'FTSPNODE0.out' u (($1 / 28800) * 1000):2 w l lw 4 t 'FTSP Global Time', 'MAPPEDNODE0.out' u (($1 / 28800) * 1000):2 w l lw 4 t 'Rectified Global Time', 'FTSPOKERROR.out' u 1:2 w l lw 4 t 'Acceptable Error = 10 ms'
#    EOF
