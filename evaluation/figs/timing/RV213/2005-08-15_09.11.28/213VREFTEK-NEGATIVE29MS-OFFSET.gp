...
set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 18
set output '213VREFTEK-NEGATIVE29MS-OFFSET.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set ylabel "Vertical Ground Displacement (Sample Value)" 0.000000,0.000000  font ""
...
plot 'node-213.dat' u (($1 - 1124097227) + 0.029):($2) w l lt 1 lw 4 t "Node 213 shifted 29 ms later", 'node-9024.dat' u ($1 - 1124097227):($2) w l lw 4 lt 3 t "RVEN wired seismic station"
#    EOF
