...
set key title ""
set key right bottom Right noreverse enhanced box linetype -2 linewidth 1.000 samplen 4 spacing 1 width 0 height 0 autotitles
unset label
unset arrow
unset style line
unset style arrow
...
set xlabel "Fetch download time (sec)" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ 0.00000 : 600.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Prob [X {/Symbol \243} x]" 0.000000,0.000000  font ""
...
plot 'CDFBYHOPS200.out' u ($1*60):($2) w l lw 5 t "Node 200 (1 hop)", \
     'CDFBYHOPS214.out' u ($1*60):($2) w l lw 5 lt 3 t "Node 214 (6 hops)"
#    EOF
