...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./evaluation/figs/timing/MDW/instability/FTSPINSTABILITY.pdf}
\end{center} 
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.8\hsize]{./evaluation/figs/timing/RectificationCartoon/cartoon.pdf}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/ComparisonFigure/COMPARISONFIGURE.pdf}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./evaluation/figs/timing/MDW/rectification/rectify.pdf}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/FTSPRuns/FTSPDOWN-RUNS-CDF.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TelosLabNew/FTSPVMAPPEDNODE0.pdf}
%{\small {\bf (a, 1 hop)}}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TelosLabNew/FTSPVMAPPEDNODE6.pdf}
%{\small {\bf (b, 6 hops)}}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TelosLabTiming/MAPPINGERROR.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TimingHeuristicRuns/HEURISTIC-1SEC.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TimingHeuristicRuns/HEURISTIC-1HOUR.pdf}
%\end{center}
%\caption{\small{\bf Time Location of Consecutive Runs of Timestamps with
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TimingHeuristicRuns/HEURISTIC-60SEC.pdf}
%\end{center}
%\caption{\small{\bf Time Location of Consecutive Runs of Timestamps with
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/FirstReftekComparison/COMPARISON-SHIFTED.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TimingHeuristicDiffs/TIMINGHEURISTICABS.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/SampleRates/SAMPLERATESHISTOGRAM.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TelosLabTiming/ABSOLUTEERROR.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/TelosLabTiming/MAPPEDERROR.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/FirstReftekComparison/COMPARISON-UNSHIFTED.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/GlobalTimeProblem/GlobalTimeProblem.pdf}
%\end{center}
%\caption{\small{\bf Example of FTSP Instability Observed During Field
%Deployment}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/MDW/rectification/rectify-STEP1.pdf}
%(a)
%\includegraphics[width=\hsize]{./evaluation/figs/timing/MDW/rectification/rectify-STEP2.pdf}
%(b)
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./evaluation/figs/timing/FTSPUpDown/FTSPDOWN.pdf}
%\end{center}
