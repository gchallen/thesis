...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./casestudy/figs/performance/yields/comparison/availableEventNodeYieldCDF.pdf}
\end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/comparison/schBlockYieldCDF_entire.pdf}
%% \end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/yields/comparison/nodePercentiles.pdf}
%\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./casestudy/figs/performance/yields/nodeYield/nodeYieldOnly.pdf}
\end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/nodeYield/nodeYield.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/beforeReprogram/schBlockYieldCDFByNode.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/afterReprogram/schBlockYieldCDFByNode.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/expNodeYield.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/expBlockYield.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/schNodeYield.pdf}
%% \end{center}
...
%% \begin{figure}[t]
%% \begin{center}
%% \includegraphics[width=\hsize]{./casestudy/figs/performance/yields/schBlockYield.pdf}
%% \end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\hsize]{./casestudy/figs/performance/CDFByHops/CDFBYHOPS.pdf}
\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/fetchspeed/fetchspeed-cdf-oldnew.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/fetchspeed-byhops/fetchspeed-oldnew.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/fetchspeed/fetchspeed-cdf.pdf}
%\end{center}
%\caption{\small{\bf Fetch throughput.}
%{\em This graph shows a CDF of the the throughput for each fetch
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/fetchlatency/fetch-latency-cdf.pdf}
%\end{center}
...
%\begin{figure}[t]
%\begin{center}
%\includegraphics[width=\hsize]{./casestudy/figs/performance/fetchlatency/fetchlatency-byhops.pdf}
%\end{center}
