...
studies and hazard monitoring. Figure~\ref{introduction-fig-cartoon} displays an overview
...
active volcanoes in Ecuador. Figure~\ref{introduction-fig-deployment-maps} shows the
...
\begin{figure}[]
\label{introduction-fig-deployment-maps}
\begin{center}
...
\textbf{(b)}
\end{center}
\caption{\textbf{Deployment locations.} Figures \textbf{a} and \textbf{b}
show the locations of our second and third volcano deployments, in 2005 and
2007. Figure \textbf{a} shows 17 nodes deployed on Reventador Volcano;
\textbf{b} shows eight nodes deployed on Tungurahua Volcano.}
\end{figure}
