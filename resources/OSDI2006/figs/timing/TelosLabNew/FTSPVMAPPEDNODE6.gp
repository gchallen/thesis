...
set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 18
set output 'FTSPVMAPPEDNODE6.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xlabel "Error (ms)" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Prob [X <= x]" 0.000000,0.000000  font ""
...
plot 'FTSPNODE6.out' u (($1 / 28800) * 1000):2 w l lw 4 t 'FTSP Global Time', 'MAPPEDNODE6.out' u (($1 / 28800) * 1000):2 w l lw 4 t 'Rectified Global Time', 'FTSPOKERROR.out' u 1:2 w l lw 4 t 'Acceptable Error = 10 ms' 
#    EOF
