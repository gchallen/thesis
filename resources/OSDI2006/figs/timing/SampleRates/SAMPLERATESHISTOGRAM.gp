...
# set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 18
# set output 'SAMPLERATESHISTOGRAM.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xlabel "Difference from Expected Sample Rate (mHz)" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ -10.0000 : 10.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Count" 0.000000,0.000000  font ""
...
plot 'SAMPLERATESHISTOGRAM.out' u ($1 * 1000):2 w filledcurves t ''
#    EOF
