...
set output 'FTSPDOWN-RUNS-CDF.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set my2tics default
set mcbtics default
set xtics border mirror norotate  ("1000" 1000.00, "300" 300.000, "100" 100.000, "10" 10.0000, "1" 1.00000, "0.1" 0.100000)
...
set xlabel "FTSP Outage Length (sec)" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ 0.100000 : 1000.00 ] noreverse nowriteback
...
set key bottom left
plot 'FTSPDOWN-RUNS-CDF.out' u 1:2 w l lw 4 t "", 'FTSPDOWN-RUNS-CDF-STATS.out' u 1:2 w l lw 4 t "Filter Cutoff Point = 300 sec (5 min)"
#    EOF
